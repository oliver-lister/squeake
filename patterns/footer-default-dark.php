 ...
 * Slug: squeake/footer-default-dark
 * Categories: footer
...
<p>&copy; <?php echo esc_html( gmdate( 'Y' ) ); ?> <?php echo esc_html__( 'Your Company LLC', 'squeake' ); ?> · <a href="#"><?php echo esc_html__( 'Contact Us', 'squeake' ); ?></a></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><a href="#"><?php echo esc_html__( 'Facebook', 'squeake' ); ?></a> · <a href="#"><?php echo esc_html__( 'Twitter', 'squeake' ); ?></a> · <a href="#"><?php echo esc_html__( 'Instagram', 'squeake' ); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
