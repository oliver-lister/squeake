 ...
 * Slug: squeake/footer-three-columns-dark
 * Categories: footer
...
<!-- wp:paragraph -->
<p>&copy; <?php echo esc_html( gmdate( 'Y' ) ); ?> <?php echo esc_html__( 'Your Company LLC', 'squeake' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><a href="#"><?php echo esc_html__( 'Privacy Policy', 'squeake' ); ?></a> · <a href="#"><?php echo esc_html__( 'Terms of Service', 'squeake' ); ?></a> · <a href="#"><?php echo esc_html__( 'Contact Us', 'squeake' ); ?></a></p>
<!-- /wp:paragraph -->
